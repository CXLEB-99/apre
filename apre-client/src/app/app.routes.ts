...
import { AgentPerformanceBySupervisorComponent } from './reports/agent-performance/by-supervisor/agent-performance-by-supervisor.component';
...
import { SalesByTimePeriodComponent } from './reports/sales/sales-by-time-period/sales-by-time-period.component';
import { ByChannelComponent } from './reports/customer-feedback/by-channel/by-channel.component';
// Import the components for reports
...
export const salesReportRoutes: Routes = [
  ...
  {
    path: 'sales-by-time-period',
    component: SalesByTimePeriodComponent
  }
